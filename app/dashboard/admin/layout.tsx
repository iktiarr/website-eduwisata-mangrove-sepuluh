...
export default function KasirLayout({ children }: { children: React.ReactNode }) {
  ...
  { 
    name: "🌐 Menu Booking",
    path: "/dashboard/admin/menu_booking"
  },
  { 
    name: "⏰ Menu Jam Operasional",
    path: "/dashboard/admin/menu_jam_operasional"
  },
  { 
    name: "⚙️ Menu Pengaturan",
    path: "/dashboard/admin/menu_pengaturan"
  },
  { 
    name: "📢 Menu Pengumuman",
    path: "/dashboard/admin/menu_pengumuman"
  },
  { 
    name: "👥 Menu User",
    path: "/dashboard/admin/menu_user"
  },
  { 
    name: "⭐ Menu Ulasan",
    path: "/dashboard/admin/menu_ulasan"
  },
];
    ...
    <div className="flex h-screen bg-gray-100 font-sans text-gray-800 overflow-hidden">
      ...
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col shrink-0 transition-all duration-300">
        ...
        <div className="h-16 flex items-center justify-center border-b border-gray-100 bg-green-600">
          <h1 className="text-xl font-bold text-white tracking-wide">ADMIN MANGROVE</h1>
        </div>
